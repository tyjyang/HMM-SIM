...
# with command line options: --fast --filein file:step0.root --fileout file:step1_1.root --mc --eventcontent PREMIXRAW --runUnscheduled --datatier GEN-SIM-DIGI --conditions 106X_mc2017_realistic_v6 --step DIGI,DATAMIX,L1,DIGI2RAW --procModifiers premix_stage2 --nThreads 8 --geometry DB:Extended --datamix PreMix --era Run2_2017 --python_filename step1_1.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 2
...
process = cms.Process('DIGI2RAW',Run2_2017,fastSim,premix_stage2)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--fast nevts:2'),
...
process.PREMIXRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:step1_1.root'),
