...
# with command line options: Configuration/GenProduction/python/HIG-RunIIULwmLHEGS-fragment.py --fileout file:step0.root --mc --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 106X_mc2017_realistic_v6 --beamspot Realistic25ns13TeVEarly2017Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2017 --nThreads 8 --python_filename step0.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 500 --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(81)
# Note: initialSeed is randomized by bash input
#       lumiBlock is specified by bash input for each cmsRun execution as well
...
process.configurationMetadata = cms.untracked.PSet(
		annotation = cms.untracked.string('file:HIG-RunIIULwmLHEGS-fragment.py nevts:500'),
